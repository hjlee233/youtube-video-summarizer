...
> **구현 현황 (2026-06-20):** 1~4단계(CLI 파이프라인 · Streamlit UI · 로그인/멤버십 영상 · 보안 정리)
> 구현 완료. 멤버십/보호 영상은 Firefox 쿠키 + Deno + EJS 솔버로 지원한다.
> 미구현: 작업 상태 기반 재개·동일 영상 캐시(P1 일부), 5단계 화자 분리(2차).
